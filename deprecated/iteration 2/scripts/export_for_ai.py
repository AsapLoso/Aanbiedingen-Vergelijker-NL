...
# Use the database utility from the same folder
# We assume this script is in deprecated/iteration 2/scripts/
sys.path.append(os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
try:
    from database.db import DB_PATH
except ImportError:
    # Fallback for localized run
    DB_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), 'database', 'flyers.db')
